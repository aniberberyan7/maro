    ...
    <div className="relative bg-[url('/images/graphics/pattern-slider.png')] bg-repeat bg-contain overflow-hidden flex justify-center h-20 md:h-40 xl:h-50">
      ...
      <div className="relative flex flex-row items-center gap-x-2 xl:gap-x-4 z-10">
        <div className="relative hidden md:block md:w-50 md:h-33 xl:w-75 xl:h-50 top-7">
            <Image src="/images/graphics/food-2.png" alt="Delivery" fill sizes="(max-width: 768px) 50px, (max-width:1200px) 75px, 100px" />
        </div>
        
        <h2 className="text-lg md:text-2xl xl:text-3xl font-bold text-[#414141]"> Հյութեր՝ չիայի սերմերով </h2>
      </div>
    </div>
  )
}
